...
print("robot type model information\n")
print(robot_type_model_information)
print("\n\n")

robot_type_model_information.to_csv("robot_type_model_information.csv",index=False)
...
print("source model name information\n")
print(source_model_name_information)
print("\n\n")


source_model_name_information.to_csv("source_model_name_information.csv",index=False)